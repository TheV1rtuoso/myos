...
void exception_handler(InterruptFrame intr_frame)
{
    ...
    printf("CPU Interrupt %x, Reason: %s\n",
...
const char* interrupt_type_to_string(InterruptType type) {
    switch (type) {
        case InterruptType::Fault: return "Fault";
        case InterruptType::Abort: return "Abort";
        case InterruptType::Interrupt: return "Interrupt";
        case InterruptType::Trap: return "Trap";
...
const char* get_interrupt_name(InterruptVector vec){
    switch (vec) {
        case InterruptVector::DivisionError: return "Division Error";
        case InterruptVector::Debug: return "Debug";
        case InterruptVector::NonMaskableInterrupt: return "Non-maskable Interrupt";
        case InterruptVector::Breakpoint: return "Breakpoint";
        case InterruptVector::Overflow: return "Overflow";
        case InterruptVector::BoundRangeExceeded: return "Bound Range Exceeded";
        case InterruptVector::InvalidOpcode: return "Invalid Opcode";
        case InterruptVector::DeviceNotAvailable: return "Device Not Available";
        case InterruptVector::DoubleFault: return "Double Fault";
        case InterruptVector::CoprocessorSegmentOverrun: return "Coprocessor Segment Overrun";
        case InterruptVector::InvalidTSS: return "Invalid TSS";
        case InterruptVector::SegmentNotPresent: return "Segment Not Present";
        case InterruptVector::StackSegmentFault: return "Stack-Segment Fault";
        case InterruptVector::GeneralProtectionFault: return "General Protection Fault";
        case InterruptVector::PageFault: return "Page Fault";
        case InterruptVector::x87FloatingPointException: return "x87 Floating-Point Exception";
        case InterruptVector::AlignmentCheck: return "Alignment Check";
        case InterruptVector::MachineCheck: return "Machine Check";
        case InterruptVector::SIMDFloatingPointException: return "SIMD Floating-Point Exception";
        case InterruptVector::VirtualizationException: return "Virtualization Exception";
        case InterruptVector::ControlProtectionException: return "Control Protection Exception";
        case InterruptVector::HypervisorInjectionException: return "Hypervisor Injection Exception";
        case InterruptVector::VMMCommunicationException: return "VMM Communication Exception";
        case InterruptVector::SecurityException: return "Security Exception";
        default: return "Unknown";
    }
}